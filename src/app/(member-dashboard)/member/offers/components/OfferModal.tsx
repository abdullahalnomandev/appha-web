...
export const OfferModal: React.FC<{
    ...
    const imageUrls = images.map((img) => getImage(img)); // ✅ fixed

    // Determine location (address or similar field)
    const locationStr = (data as any).address || (data as any).location || "";
            ...
            >
                ...
                <div style={{ padding: "20px 22px 0 22px", background: "#fff" }}>
                    ...
                    {(!!locationStr || !!data.category?.name) && (
                        ...
                        >
                            <EnvironmentFilled
                                style={{ marginRight: 5, fontSize: 15, color: "#fa541c" }}
                            />
                    ...
                    {(data as any).features?.length ? (
                        <ul
                            style={{
                                margin: "8px 0 0 20px", // spacing from above
                                padding: 0,
                                color: "#232f3e",
                                fontSize: 14,
                                lineHeight: "23px",
                    ...
                    {(data as any).terms ||
                        (Array.isArray((data as any).termsAndConditions) &&
                            (data as any).termsAndConditions.length > 0) ? (
                        <div
                            style={{
                                marginTop: 24,
                                background: "#fbfcfd",
